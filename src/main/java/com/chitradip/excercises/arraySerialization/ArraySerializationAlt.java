...
public class ArraySerializationAlt {
    /*
    ...
    private  static Pattern delimOrEscape;

    public ArraySerializationAlt() {
        this.delim = ',';
        escapeChar = '\\';
        delimOrEscape = Pattern.compile("([\\,])");
        Matcher matcher = delimOrEscape.matcher("a,b");
